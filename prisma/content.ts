...
<ul>
    ...
    challenges: [
      {
        ...
        options: ["3", "4", "5", "6"],
        correctAnswer: "2",
        explanation: "El pentagrama tiene exactamente 5 líneas horizontales paralelas y 4 espacios entre ellas.",
      },
      {
        order: 2,
        question: "La clave de Sol indica que la nota Sol se ubica en la ___ línea del pentagrama.",
        type: "MULTIPLE_CHOICE",
        options: ["1ª", "2ª", "3ª", "4ª"],
        correctAnswer: "1",
        explanation: "El bucle de la clave de Sol rodea la 2ª línea, que es donde se ubica la nota Sol.",
      },
      {
        order: 3,
        question: "¿Cuántos tiempos vale una redonda?",
        type: "MULTIPLE_CHOICE",
        options: ["1", "2", "3", "4"],
        correctAnswer: "3",
        explanation: "La redonda es la figura de mayor duración básica y vale 4 tiempos.",
      },
      {
        order: 4,
        question: "¿Cuántas corcheas equivalen a una blanca?",
        type: "MULTIPLE_CHOICE",
        options: ["2", "4", "6", "8"],
        correctAnswer: "1",
        explanation: "Una blanca vale 2 tiempos y una corchea vale ½ tiempo, por lo tanto 4 corcheas = 1 blanca.",
      },
      {
        order: 5,
        question: "En un compás de 4/4, la negra es la unidad de pulso.",
        type: "TRUE_FALSE",
        options: ["Verdadero", "Falso"],
        correctAnswer: "0",
        explanation: "Correcto. En 4/4 el número inferior (4) indica que la negra es la figura que vale 1 pulso.",
      },
      {
        order: 6,
        question: "¿Qué indica un sostenido (#) delante de una nota?",
        type: "MULTIPLE_CHOICE",
        options: ["Baja la nota un semitono", "Sube la nota un semitono", "Anula una alteración anterior", "Duplica la duración"],
        correctAnswer: "1",
        explanation: "El sostenido (#) sube la nota un semitono (medio tono) respecto a su altura natural.",
      },
      {
        order: 7,
        question: "La escala de Do Mayor utiliza todas las notas naturales sin alteraciones.",
        type: "TRUE_FALSE",
        options: ["Verdadero", "Falso"],
        correctAnswer: "0",
        explanation: "Correcto. Do-Re-Mi-Fa-Sol-La-Si-Do son las 7 notas naturales y forman la escala de Do Mayor.",
      },
      {
        order: 8,
        question: "¿Cuántos espacios tiene el pentagrama?",
        type: "MULTIPLE_CHOICE",
        options: ["3", "4", "5", "6"],
        correctAnswer: "1",
        explanation: "El pentagrama tiene 4 espacios: uno entre cada par de líneas consecutivas.",
      },
      {
        order: 9,
        question: "La clave de Fa se utiliza habitualmente para...",
        type: "MULTIPLE_CHOICE",
        options: ["Violín y flauta", "Guitarra y voz aguda", "Bajo y contrabajo", "Piano solo"],
        correctAnswer: "2",
        explanation: "La clave de Fa es la clave de los instrumentos graves: bajo, contrabajo, cello y la mano izquierda del piano.",
      },
      {
        order: 10,
        question: "¿Qué figura rítmica vale la mitad de una negra?",
        type: "MULTIPLE_CHOICE",
        options: ["Redonda", "Blanca", "Corchea", "Semicorchea"],
        correctAnswer: "2",
        explanation: "La negra vale 1 tiempo y la corchea vale ½ tiempo, por lo tanto la corchea es la mitad de la negra.",
      },
    ],
  },
  ...
  "level-2-final": {
    ...
    challenges: [
      {
        order: 1,
        question: "¿Cuántos semitonos hay en un intervalo de 3ª Mayor?",
        type: "MULTIPLE_CHOICE",
        options: ["2", "3", "4", "5"],
        correctAnswer: "2",
        explanation: "La 3ª Mayor tiene 4 semitonos (por ejemplo: Do-Mi). La 3ª menor tiene 3 semitonos.",
      },
      {
        order: 2,
        question: "El compás de 6/8 tiene ___ corcheas por compás.",
        type: "MULTIPLE_CHOICE",
        options: ["4", "6", "8", "9"],
        correctAnswer: "1",
        explanation: "En 6/8 el número superior (6) indica 6 corcheas por compás, agrupadas en dos grupos de tres.",
      },
      {
        order: 3,
        question: "¿Qué tipo de triada se construye apilando 3ª menor + 5ª justa?",
        type: "MULTIPLE_CHOICE",
        options: ["Mayor", "Menor", "Aumentada", "Disminuida"],
        correctAnswer: "1",
        explanation: "La triada Menor = fundamental + 3ª menor (3 semitonos) + 5ª justa (7 semitonos desde la fundamental).",
      },
      {
        order: 4,
        question: "La triada disminuida se construye con 3ª menor + 5ª disminuida.",
        type: "TRUE_FALSE",
        options: ["Verdadero", "Falso"],
        correctAnswer: "0",
        explanation: "Correcto. La triada disminuida tiene 3ª menor (3st) + 5ª disminuida (6st), creando una sonoridad tensa.",
      },
      {
        order: 5,
        question: "¿Qué fórmula define la escala Mayor?",
        type: "MULTIPLE_CHOICE",
        options: ["T-ST-T-T-ST-T-T", "T-T-ST-T-T-T-ST", "ST-T-T-ST-T-T-T", "T-T-T-ST-T-T-ST"],
        correctAnswer: "1",
        explanation: "La escala Mayor sigue el patrón Tono-Tono-Semitono-Tono-Tono-Tono-Semitono (T-T-ST-T-T-T-ST).",
      },
      {
        order: 6,
        question: "¿Qué es una síncopa?",
        type: "MULTIPLE_CHOICE",
        options: ["Un acorde de 4 notas", "El desplazamiento del acento al tiempo débil", "Un cambio de compás", "Una escala cromática"],
        correctAnswer: "1",
        explanation: "La síncopa ocurre cuando el acento rítmico cae en un tiempo débil o parte débil del pulso, generando tensión rítmica.",
      },
      {
        order: 7,
        question: "En el cifrado americano, 'Am' representa...",
        type: "MULTIPLE_CHOICE",
        options: ["La triada de La Mayor", "La triada de La Menor", "El acorde de La Aumentado", "La séptima de La"],
        correctAnswer: "1",
        explanation: "En el cifrado americano, la letra sola indica Mayor y la letra + 'm' indica Menor. 'Am' = La Menor.",
      },
      {
        order: 8,
        question: "Un puntillo agrega a la figura ___ de su valor original.",
        type: "MULTIPLE_CHOICE",
        options: ["Un cuarto", "Un tercio", "La mitad", "El doble"],
        correctAnswer: "2",
        explanation: "El puntillo aumenta la duración de la figura en la mitad de su valor. Ejemplo: negra con puntillo = 1 + ½ = 1,5 tiempos.",
      },
      {
        order: 9,
        question: "¿Cuántas notas tiene una triada?",
        ...
        options: ["2", "3", "4", "5"],
        correctAnswer: "1",
        explanation: "Una triada tiene exactamente 3 notas: fundamental, 3ª y 5ª.",
      },
      {
        order: 10,
        question: "El intervalo de 5ª justa tiene 7 semitonos.",
        type: "TRUE_FALSE",
        options: ["Verdadero", "Falso"],
        correctAnswer: "0",
        explanation: "Correcto. La 5ª justa abarca 7 semitonos. Por ejemplo, Do-Sol tiene exactamente 7 semitonos.",
      },
    ],
  },
  ...
  "level-3-final": {
    ...
    challenges: [
      {
        order: 1,
        question: "En la tonalidad de Do Mayor, ¿cuál es el acorde del V grado?",
        type: "MULTIPLE_CHOICE",
        options: ["Fa Mayor", "Sol Mayor", "La Menor", "Si Disminuido"],
        correctAnswer: "1",
        explanation: "El V grado de Do Mayor es Sol Mayor (Sol-Si-Re). Es el acorde dominante, con función de tensión hacia el I.",
      },
      {
        order: 2,
        question: "¿Qué función armónica cumple el IV grado?",
        type: "MULTIPLE_CHOICE",
        options: ["Tónica", "Dominante", "Subdominante", "Sensible"],
        correctAnswer: "2",
        explanation: "El IV grado cumple función Subdominante: aleja de la tónica y precede habitualmente a la Dominante.",
      },
      {
        order: 3,
        question: "¿Cuántas notas tiene un acorde de séptima dominante?",
        type: "MULTIPLE_CHOICE",
        options: ["3", "4", "5", "6"],
        correctAnswer: "1",
        explanation: "Un acorde de séptima tiene 4 notas: fundamental, 3ª, 5ª y 7ª.",
      },
      {
        order: 4,
        question: "El modo Dórico comienza en el ___ grado de la escala Mayor.",
        type: "MULTIPLE_CHOICE",
        options: ["1º", "2º", "3º", "4º"],
        correctAnswer: "1",
        explanation: "Los modos se construyen comenzando en cada grado de la escala Mayor. El Dórico parte del 2º grado.",
      },
      {
        order: 5,
        question: "La escala pentatónica mayor tiene 5 notas.",
        type: "TRUE_FALSE",
        options: ["Verdadero", "Falso"],
        correctAnswer: "0",
        explanation: "Correcto. La escala pentatónica (del griego penta = cinco) tiene exactamente 5 notas por octava.",
      },
      {
        order: 6,
        question: "¿Qué nota adicional tiene la escala de Blues respecto a la pentatónica menor?",
        type: "MULTIPLE_CHOICE",
        options: ["La 2ª mayor", "La 4ª justa", "La 5ª disminuida (blue note)", "La 6ª menor"],
        correctAnswer: "2",
        explanation: "La escala de Blues agrega la 5ª disminuida (también llamada blue note o tritono) a la pentatónica menor.",
      },
      {
        order: 7,
        question: "¿Cuál es la forma de canción más común en el jazz estándar?",
        type: "MULTIPLE_CHOICE",
        options: ["A-B-C-D", "A-A-B-A", "A-B-A-C", "A-B-C-B"],
        correctAnswer: "1",
        explanation: "La forma A-A-B-A (32 compases: 8+8+8+8) es la estructura más frecuente en los estándares de jazz y música popular.",
      },
      {
        order: 8,
        question: "Una frase musical se compone habitualmente de ___ compases.",
        type: "MULTIPLE_CHOICE",
        options: ["2", "4 u 8", "6", "10"],
        correctAnswer: "1",
        explanation: "En la música tonal la frase más común tiene 4 u 8 compases, conformando una unidad melódico-armónica completa.",
      },
      {
        order: 9,
        question: "El modo Mixolidio es igual a la escala mayor pero con el ___ grado rebajado.",
        type: "MULTIPLE_CHOICE",
        options: ["3º", "5º", "6º", "7º"],
        correctAnswer: "3",
        explanation: "El Mixolidio = escala Mayor con la 7ª rebajada un semitono. Se usa sobre el acorde dominante (V7).",
      },
      {
        order: 10,
        question: "La progresión I-IV-V-I es un ejemplo de movimiento armónico...",
        type: "MULTIPLE_CHOICE",
        options: ["Modal", "Cromático", "Funcional tonal", "Atonal"],
        correctAnswer: "2",
        explanation: "I-IV-V-I es la progresión funcional tonal por excelencia: establece tónica, se mueve a subdominante, dominante y resuelve.",
      },
    ],
  },
};
